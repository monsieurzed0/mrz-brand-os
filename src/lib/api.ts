...
export const api = {
  ...
  // Brand memory
  getBrandMemory: () => apiFetch<BrandMemorySection[]>('/api/brand-memory'),
  ...
  // Media center
  getMediaLinks: () => apiFetch<MediaLink[]>('/api/media-links'),
  ...
  // Projects
  getProjects: () => apiFetch<ProjectItem[]>('/api/projects'),
