...
export const STATUS_COLORS: Record<string, string> = {
  ...
  sent: 'bg-exec/20 text-exec',
  partial: 'bg-copper/20 text-copper-light',
  paid: 'bg-copper/35 text-ivory',
  overdue: 'bg-copper-light/25 text-copper-light',
  cancelled: 'bg-dark text-subtle',
